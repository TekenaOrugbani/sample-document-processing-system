...
namespace DocumentProcessor.WebForms.Services
{
    public class DocumentTextExtractor
    {
        ...
        {
            var maxPages = AppSettings.BedrockMaxPdfPages;
            var maxCharacters = AppSettings.BedrockMaxInputCharacters;
        ...
        private string ExtractFromText(Stream content)
        {
            ...
            {
                return Truncate(reader.ReadToEnd(), AppSettings.BedrockMaxInputCharacters);
            }
        }
