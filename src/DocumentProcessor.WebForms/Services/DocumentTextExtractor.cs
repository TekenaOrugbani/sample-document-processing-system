...
namespace DocumentProcessor.WebForms.Services
{
    public class DocumentTextExtractor
    {
        ...
        public DocumentTextExtractor(IOptions<AppSettings> options)
        {
        ...
        {
            var maxPages = _appSettings.BedrockMaxPdfPages;
            var maxCharacters = _appSettings.BedrockMaxInputCharacters;
        ...
        private string ExtractFromText(Stream content)
        {
            ...
            {
                return Truncate(reader.ReadToEnd(), _appSettings.BedrockMaxInputCharacters);
            }
        }
