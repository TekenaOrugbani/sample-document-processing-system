...
namespace DocumentProcessor.WebForms.Data
{
    ...
    {
        /// <summary>
        /// Resolves the database connection using the supplied settings.
        /// </summary>
        /// <param name="settings">Strongly-typed application settings.</param>
        ...
        private static async Task<DatabaseConnection> FromSecretsManagerAsync(string descriptionPrefix)
        {
            using (var client = new AmazonSecretsManagerClient())
            {
                ...
                var match = secrets.SecretList?.FirstOrDefault(
